...
class AuthController extends Controller
{
    ...
    */
    ...
    public function postRegister(RegistrationRequest $request, AppMailers $mailer) {
        ...
        //ipansuryadiflash()->overlay('Info', 'Thanks, please login.');
    ...
    public function confirmEmail($token) {
        ...
        // Flash a info message saying you need to confirm your email.
        //ipansuryadiflash()->success('Success', 'You are now confirmed. Please sign in.');
...
$rand_brands = Brand::orderByRaw('RAND()')->take(6)->get();
    ...
    public function postLogin(Request $request) {
        ...
        if ($this->signIn($request)) {
            ////ipansuryadiflash()->success('Success', 'You have successfully signed in.');
        ...
        //ipansuryadiflash()->customErrorOverlay('Error', 'Could not sign you in with those credentials');

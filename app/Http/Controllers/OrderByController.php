...
class OrderByController extends ProductsController {
    ...
    public function productsPriceHighest($id, Product $product) {
        ...
        return view('category.show', ['products' => $products], compact('categories', 'category', 'brands', 'search', 'count', 'cart_count', 'rand_brands'));
    }
    ...
    public function productsPriceHighestBrand($id, Product $product) {
        ...
        $cart_count = $this->countProductsInCart();
        $rand_brands = Brand::orderByRaw('RAND()')->take(6)->get();
        return view('brand.show', ['products' => $products], compact('brands', 'brand', 'category', 'search', 'count', 'cart_count', 'rand_brands'));
    }
    ...
    public function productsPriceLowestBrand($id, Product $product) {
        ...
        $cart_count = $this->countProductsInCart();
        $rand_brands = Brand::orderByRaw('RAND()')->take(6)->get();
        return view('brand.show', ['products' => $products], compact('brands', 'category', 'brand', 'search', 'count', 'cart_count', 'rand_brands'));
    }

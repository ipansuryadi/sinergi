...
@section('content')
    ...
    <div class="container">
        ...
        <a href="{{ route('admin.product.show') }}" class="btn btn-danger">Back</a>
        <br><br>
        ...
        <div class="col-md-12">
            ...
            @else
                ...
                @else
                    <form method="POST" action="{{url('/')}}/admin/products/{{ $products->id }}/photo" class="dropzone" id="addProductImages" enctype="multipart/form-data">
                        {{ csrf_field() }}
                    </form>
                @endif
            @endif
                    ...
                    <div class="row" id="image_row">
                        @foreach ($set as $photo)
                            <div class="col-xs-6 col-sm-3 col-md-3 gallery_image">
                                ...
                                @else
                                    <div class="img-wrap">
                                        <form method="post" action="{{url('/')}}/admin/products/photos/{{ $photo->id }}">
                                            {!! csrf_field() !!}
        ...
        <div class="col-md-12 gallery" id="gallery">
            ...
            <form method="post" action="{{url('/')}}/admin/products/add/featured/{{ $products->id }}">
                {!! csrf_field() !!}

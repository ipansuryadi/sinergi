    ...
    @foreach($cart_products as $cart_item)
        <div class="col-sm-12 col-md-12" id="Cart-Products-Container">
            ...
            <div class="col-sm-2 col-md-2" id="Carts-Sub-Containers">
                ...
                @else
                    <div class="center-on-small-only">PRODUCT PRICE</div> <div class="green-text medium-500 center-on-small-only" id="Product_Reduced-Price-Cart">{{ xformatMoney($cart_item->products->reduced_price) }}</div>
                    <br>
                    <p class="center-on-small-only">ISBN: {{ $cart_item->products->product_sku }}</p>
                @endif
            </div>
            <div class="col-sm-3 col-md-3" id="Carts-Sub-Containers">
                <form action="{{url('/')}}/cart/update" method="post" class="form-inline">
                    ...
                    <input type="hidden" name="weight" value="{{$cart_item->products->weight}}" />
